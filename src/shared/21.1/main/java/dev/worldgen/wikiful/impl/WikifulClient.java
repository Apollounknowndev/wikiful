...
public class WikifulClient {
    public static final KeyMapping DISMISS_TIP = new KeyMapping("key.wikiful.dismiss_tip", InputConstants.Type.KEYSYM, GLFW.GLFW_KEY_Y, "key.category.wikiful.wikiful");
