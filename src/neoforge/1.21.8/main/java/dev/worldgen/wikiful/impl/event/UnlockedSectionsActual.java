...
public class UnlockedSectionsActual {
    ...
    public static void add(ServerPlayer player, ResourceLocation id) {
        List<ResourceLocation> entries = new ArrayList<>(player.getData(Attachments.UNLOCKED_SECTIONS));
        entries.add(id);
        player.setData(Attachments.UNLOCKED_SECTIONS, entries);
    }
    ...
    public static boolean hasUnlocked(Player player, ResourceLocation id) {
        return player.getData(Attachments.UNLOCKED_SECTIONS).contains(id);
    }

    @Actual
    public static void clear(ServerPlayer player) {
        player.setData(Attachments.UNLOCKED_SECTIONS, List.of());
    }
}
